    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoriesOld", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Professionals_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAddresses", x => new { x.AppUserId, x.AddressId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_CategoriesOld_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "CategoriesOld",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfessionalCategories", x => new { x.CategoryId, x.ProfessionalId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfessionalGroups", x => new { x.GroupId, x.ProfessionalId });
                    table.ForeignKey(
                        name: "FK_ProfessionalGroups_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProfessionalGroups_Professionals_ProfessionalId",
                        column: x => x.ProfessionalId,
                        principalTable: "Professionals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfessionalId1 = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Services_Customers_CustomerId1",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Services_Professionals_ProfessionalId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RatingServices_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RatingServices_Professionals_ProfessionalId",
                        column: x => x.ProfessionalId,
                        principalTable: "Professionals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceDetails_ServiceOfferings_ServiceOfferingId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "CUSTUMER", null, "Custumer", "CUSTUMER" },
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Name" },
                values: new object[] { new Guid("f5a43dbc-5c5d-4e77-bdbf-037f8f9dd10d"), "Credit Card" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfessionalGroups_ProfessionalId",
                table: "ProfessionalGroups",
                column: "ProfessionalId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RatingServices_CustomerId",
                table: "RatingServices",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_RatingServices_ProfessionalId",
                table: "RatingServices",
                column: "ProfessionalId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceDetails_ServiceOfferingId",
                table: "ServiceDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Services_ProfessionalId1",
                table: "Services",
